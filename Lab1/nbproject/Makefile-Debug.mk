...
${OBJECTDIR}/AlphaHistogram.o: AlphaHistogram.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/AlphaHistogram.o AlphaHistogram.cpp
