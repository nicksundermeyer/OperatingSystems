...
${TESTDIR}/MemAllocatorTest.o: MemAllocatorTest.cpp 
	${MKDIR} -p ${TESTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/MemAllocatorTest.o MemAllocatorTest.cpp
...
${OBJECTDIR}/PageFrameAllocator_nomain.o: ${OBJECTDIR}/PageFrameAllocator.o PageFrameAllocator.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/PageFrameAllocator_nomain.o PageFrameAllocator.cpp;\
	else  \
